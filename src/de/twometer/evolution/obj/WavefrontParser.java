...
import de.twometer.evolution.obj.geom.VertexRef;
import de.twometer.evolution.obj.material.Material;
import de.twometer.evolution.obj.material.MaterialLib;
import de.twometer.evolution.res.ResourceLoader;
...
public class WavefrontParser {
    ...
    public Mesh createMesh() throws IOException {
        ...
        Mesh mesh = new Mesh(totalVertices).withNormals();
